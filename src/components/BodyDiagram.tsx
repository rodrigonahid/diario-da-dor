...
const bodyParts: BodyPart[] = [
  { id: "cabeca", name: "Cabeça", x: 47, y: 7, width: 5, height: 5 },
  ...
  { id: "perna", name: "Perna", x: 43, y: 72, width: 14, height: 20 },
  { id: "pes", name: "Pés", x: 40, y: 92, width: 20, height: 6 },
  { id: "braco-esquerdo", name: "Braço esquerdo", x: 62, y: 25,  width: 8, height: 40 },
  { id: "braco-direito", name: "Braço direito", x: 30, y: 25, width: 8, height: 40 },
];
